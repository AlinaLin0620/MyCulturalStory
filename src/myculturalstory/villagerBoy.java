...
public class villagerBoy extends Villager {
    ...
    protected void giveQuest() {
        questGiven = true;
        System.out.println("Villager Boy: Can you gather 3 bundles of firewood?");
    }
    ...
    protected void checkQuestProgress(ZodiacAnimal player) {
        if (collected >= 3) {
            questComplete = true;
            System.out.println("Firewood collected! Return to the Villager Boy."); 
        }
    }      
}
